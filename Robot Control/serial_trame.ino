...
void loop(){
 ...
 if (index == 7){
   ...
   //Treating the data
    ...
    //Treating the previous data
      previous_data = data_store[5] <<8 | data_store[6];
      Serial.println(previous_data);
   ...
   switch(cmd){
     ...
     case 0: // Motor 0
       Serial.println("The motor 0 is about to move");
       SetPosition(0,data);
       break;
     ...
     case 8: //Led ON OFF
       if (data == 0){
         Serial.println("The led is about to turn off ");
         digitalWrite(25,LOW);
         break;
       }
         
       else{
         Serial.println("The led is about to turn on ");
